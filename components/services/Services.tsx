...
function Services() {
  return (
    <section className="section_gap py-20">
        <div className="container">
            ...
            <div className="mx-[130px] py-8 row grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className=" text-center ">
                    <div className="hotel_img relative">
                        ...
                        <a rel="noopener noreferrer" href="#" className="btn theme_btn font-poppins font-medium text-lg button_hover absolute bottom-5 left-1/2 transform -translate-x-1/2 px-6 py-3 bg-yellow-400 text-white rounded-md hover:bg-yellow-500">BOOK NOW</a>
                ...
                <div className="text-center">
                    <div className="hotel_img relative">
                        ...
                        <a rel="noopener noreferrer" href="#" className="btn theme_btn font-poppins font-medium text-lg button_hover absolute bottom-5 left-1/2 transform -translate-x-1/2 transition-all duration-300 ease-in-out  px-6 py-3 bg-yellow-400 text-white rounded-md hover:bg-yellow-500">BOOK NOW</a>
                ...
                <div className="text-center">
                    ...
                    <a rel="noopener noreferrer" href="#" className="block mt-6">
                        <h4 className="sec_h4 text-2xl font-poppins font-semibold">Seminar Hall 3</h4>
                    </a>
                </div>
